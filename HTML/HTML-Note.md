# HTML Note - Made By trminhhieu (có dùng AI)
...
4. [Phân nhóm thẻ và thuộc tính](#4-phân-nhóm-thẻ-và-thuộc-tính)
...
- `<head>` **(Phần đầu trang):** Chứa các **siêu dữ liệu (metadata)** dành cho _máy móc_ (trình duyệt, công cụ tìm kiếm) đọc hiểu. Nội dung trong phần này không hiển thị trực tiếp lên không gian giao diện của người dùng.
  ...
  - `<base>`: Thiết lập URL gốc (base URL) cho tất cả các liên kết tương đối (relative URLs) trong tài liệu. Chỉ được phép có tối đa một thẻ `<base>` trong tài liệu.
...
| Thẻ & thuộc tính                                                                                                                                                                                                                                                                                              | Chức năng                                                                                                                                                             |
| ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | --------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| [`<h1>` - `<h6>`](https://developer.mozilla.org/en-US/docs/Web/HTML/Element/Heading_Elements)                                                                                                                                                                                                                 | Thẻ khối phân cấp tiêu đề (Heading).                                                                                                                                  |
| [`<p>`](https://developer.mozilla.org/en-US/docs/Web/HTML/Element/p)                                                                                                                                                                                                                                          | Thẻ khối tạo đoạn văn (Paragraph).                                                                                                                                    |
...
| [`<pre>`](https://developer.mozilla.org/en-US/docs/Web/HTML/Element/pre)                                                                                                                                                                                                                                      | Thẻ khối giữ nguyên định dạng khoảng trắng/xuống dòng gốc của văn bản (thường dùng để bọc code).                                                                      |
...
| [`<strong>`](https://developer.mozilla.org/en-US/docs/Web/HTML/Element/strong) / [`<em>`](https://developer.mozilla.org/en-US/docs/Web/HTML/Element/em)                                                                                                                                                       | Văn bản mang tính chất quan trọng (`<strong>`) / Nhấn mạnh trọng âm (`<em>`).                                                                                         |
| [`<mark>`](https://developer.mozilla.org/en-US/docs/Web/HTML/Element/mark)                                                                                                                                                                                                                                    | Highlight (làm nổi bật) văn bản mang tính liên quan hoặc cần chú ý.                                                                                                   |
| [`<s>`](https://developer.mozilla.org/en-US/docs/Web/HTML/Element/s)                                                                                                                                                                                                                                          | Văn bản đã lỗi thời hoặc không còn chính xác (Strikethrough).                                                                                                         |
| [`<small>`](https://developer.mozilla.org/en-US/docs/Web/HTML/Element/small)                                                                                                                                                                                                                                  | Dành cho các dòng in ấn nhỏ như điều khoản pháp lý, bản quyền, chú thích phụ.                                                                                         |
| [`<q>`](https://developer.mozilla.org/en-US/docs/Web/HTML/Element/q) / [`<cite>`](https://developer.mozilla.org/en-US/docs/Web/HTML/Element/cite)                                                                                                                                                             | Đoạn trích dẫn ngắn (`<q>`) / Tên một tác phẩm như sách, phim (`<cite>`).                                                                                             |
| [`<dfn>`](https://developer.mozilla.org/en-US/docs/Web/HTML/Element/dfn) / [`<abbr>`](https://developer.mozilla.org/en-US/docs/Web/HTML/Element/abbr)                                                                                                                                                         | Định nghĩa một thuật ngữ (`<dfn>`) / Từ viết tắt (`<abbr>`, nên kết hợp dùng thuộc tính title để giải thích ý nghĩa).                                                 |
| [`<code>`](https://developer.mozilla.org/en-US/docs/Web/HTML/Element/code) / [`<kbd>`](https://developer.mozilla.org/en-US/docs/Web/HTML/Element/kbd) / [`<samp>`](https://developer.mozilla.org/en-US/docs/Web/HTML/Element/samp) / [`<var>`](https://developer.mozilla.org/en-US/docs/Web/HTML/Element/var) | Định dạng cho: Mã máy / Nút bấm trên bàn phím / Đầu ra mẫu của chương trình / Tên biến toán học, lập trình.                                                           |
...
| [`<a>`](https://developer.mozilla.org/en-US/docs/Web/HTML/Element/a)                                                                                                                                                                                                                                          | Tạo siêu liên kết (Anchor), đi kèm các thuộc tính quan trọng: href, target="\_blank", download, rel.                                                                  |
...
| [`<span>`](https://developer.mozilla.org/en-US/docs/Web/HTML/Element/span)                                                                                                                                                                                                                                    | Một vùng chứa nội tuyến (inline) vô nghĩa, dùng để bọc văn bản nhằm mục đích áp dụng CSS hoặc JavaScript (thông qua class hoặc id).                                   |
| [`<sub>`](https://developer.mozilla.org/en-US/docs/Web/HTML/Element/sub) / [`<sup>`](https://developer.mozilla.org/en-US/docs/Web/HTML/Element/sup)                                                                                                                                                           | Định dạng văn bản thành chỉ số dưới (Subscript - VD: H₂O) hoặc chỉ số trên (Superscript - VD: X²) phục vụ cho quy ước đánh máy, công thức toán/hóa học hoặc cước chú. |
...
| [`<datalist>`](https://developer.mozilla.org/en-US/docs/Web/HTML/Element/datalist)                                                                                  | Chứa một tập hợp các thẻ `<option>` tạo thành một danh sách các giá trị gợi ý (autocomplete dropdown) cho thẻ `<input>` (liên kết qua thuộc tính `list`). Người dùng có thể chọn gợi ý mà không cần dùng đến JavaScript. |
...
| `<template>`                                                                                                                                                            | Thẻ chứa mã HTML mà trình duyệt sẽ phân tích cú pháp nhưng không render hiển thị ngay lúc tải trang. Nó đóng vai trò như một "bản mẫu" để JavaScript có thể nhân bản (clone) và chèn vào giao diện DOM sau này.                                                                   |
| `<slot>`                                                                                                                                                                | Một trình giữ chỗ (placeholder) bên trong một Web Component, cho phép bạn điền markup tùy chỉnh của riêng mình vào.                                                                                                                                                               |
...
| [`title`](https://developer.mozilla.org/en-US/docs/Web/HTML/Global_attributes/title)                                                                                   | Chứa thông tin cố vấn/mô tả. Khi người dùng di chuột (hover) qua phần tử, nó sẽ hiện ra một hộp tooltip nhỏ chứa văn bản.                                         |
| [`tabindex`](https://developer.mozilla.org/en-US/docs/Web/HTML/Global_attributes/tabindex)                                                                             | Quản lý việc điều hướng bằng phím Tab. Bằng `0` là theo thứ tự mặc định, `-1` là không cho phép tab tới, số dương là thứ tự ưu tiên.                              |
...
| [`contenteditable`](https://developer.mozilla.org/en-US/docs/Web/HTML/Global_attributes/contenteditable)                                                               | Bật/tắt chế độ cho phép người dùng chỉnh sửa trực tiếp nội dung của thẻ HTML ngay trên trình duyệt (như trình soạn thảo văn bản).                                 |
...
| [`autofocus`](https://developer.mozilla.org/en-US/docs/Web/HTML/Global_attributes/autofocus)                                                                           | Tự động đưa con trỏ chuột tập trung vào một phần tử (thường là form input hoặc vùng có thể chỉnh sửa) ngay khi trang web tải xong.                                |
| [`spellcheck`](https://developer.mozilla.org/en-US/docs/Web/HTML/Global_attributes/spellcheck)                                                                         | Bật/tắt tính năng gạch chân cảnh báo sai chính tả và ngữ pháp của trình duyệt (`spellcheck="true"` hoặc `spellcheck="false"`).                                    |
